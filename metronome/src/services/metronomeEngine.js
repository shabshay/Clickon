...
export class MetronomeEngine {
    constructor() {
        ...
        Object.defineProperty(this, "nextNoteTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "scheduleAheadTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0.1
        ...
        Object.defineProperty(this, "tickSubscribers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "stateSubscribers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    scheduleTick(step, time) {
        const settings = this.settings;
        if (!settings || !this.audioCtx)
            return;
    ...
    advanceStep() {
        if (!this.settings || !this.audioCtx)
            return;
    ...
    triggerBeep(time, frequency, gainValue) {
        if (!this.audioCtx)
            return;
    ...
    triggerBuffer(type, time, gainValue, isAccent) {
        if (!this.audioCtx)
            return;
